...
void Persona::mostrar(){
  cout <<"Hola soy " << nombre <<" y tengo "<< edad
  <<" anios. Naci el " << fecha_nacimiento.dia <<" del "
  << fecha_nacimiento.mes << " de " << fecha_nacimiento.anio<<endl;
}
...
bool Persona::es_mismo_nombre(string nombre){
